            ...
            <div className='border border-gray-500 px-5 py-2 mt-6 relative'>
                  ...
                  {todoList?.length === 0 && (
                        <div className='h-12 px-6 rounded'>
                              <h1 className='text-center btn-shine text-xl'>
                  ...
                  {showRemove && (
                        <div className='absolute shadow-todoShadow top-20 lg:left-40 left-2 mx-auto border border-red-400 lg:pb-0 pb-6 lg:h-28 lg:w-[380px] bg-bodyColors rounded'>
                              <h1 className='text-xl text-center mt-3 text-red-500 font-medium'>Are you sure to remove all the todos?</h1>
                              <div className='flex gap-4 mt-4 lg:ml-24 ml-14'>
                                    ...
                                    <button onClick={() => dispatch(allReset(), setShowRemove(false), toast.success("All todo deleted successfully!"))} className='border border-gray-500 py-2 px-6 hover:border-red-500 hover:text-red-500 duration-300 text-orange-400'>Yes</button>
                              </div>
                        </div>
                  )}
            </div>
